...
%         % \node[anchor=south east, yshift=0.2cm, xshift=-0.3cm] at (current page.south east) {
%         %     \includegraphics[height=0.23cm]{fig/logo_thales.png}
%         % };
%         % \node[preaction={fill, white}, anchor=south, yshift=0.2cm, text=green] at (current page.south) {
%         %     \color{greenconfi} \tiny Thales Group Limited Distribution
%         % };
%         \node[rotate=90, anchor=center, yshift=-.3cm, text=green] at (current page.west) {
%           \scalebox{0.6}{
%             \begin{minipage}{1.2\paperheight}
%               \centering \color{greenconfi} \tiny Thales Group Limited Distribution
%             \end{minipage}
%           }
%       };
%     %   \node[anchor=south west, yshift=0.3cm, xshift=0.3cm] at (current page.south west) {
%     %     \color{blue} \tiny \insertframenumber/\inserttotalframenumber
%     % };
%     \end{tikzpicture}
% }
