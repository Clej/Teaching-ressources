...
\begin{frame}{\subsecname}
  ...
  \begin{itemize}
    ...
    %
    \item<6-> Pour n'importe quel $x_0$: accès à la prédiction moyenne, son incertitude (intervalle de confiance), quantiles, etc., de $y_0$
    %
    \item<7-> La prédiction dépend aussi de $\theta$ (hyperparamètre) !
  \end{itemize}
\end{frame}
